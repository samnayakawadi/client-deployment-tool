...
const Dashboard = () => {
    ...
    return (
        <div className="h-full px-2 flex flex-row gap-3 w-full flex-grow">

            <div className="h-full basis-9/12 overflow-y-auto">
            ...
            <div className="h-full basis-3/12 overflow-y-auto border">
