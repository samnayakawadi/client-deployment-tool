                ...
                <div className="modal-box p-3 flex flex-col gap-2">
                    <div className="flex flex-row justify-center gap-2">
                        <div className="basis-6/12">
                            <a href={dashboardHandlers.downloadClientJSONURLGenerator()} htmlFor="globalModal" className="btn no-animation btn-accent btn-block normal-case">Data.json</a>
                        </div>
                        <div className="basis-6/12">
                            <a href={dashboardHandlers.downloadClientPropertiesURLGenerator()} htmlFor="globalModal" className="btn no-animation btn-accent btn-block normal-case">Data.properties</a>
                        </div>
                    </div>
                    <div>
