            ...
            <div className="modal">
                <div className="modal-box p-3 flex flex-col gap-2">
                    <div className="flex flex-row justify-center gap-2">
                        ...
                        <div className="basis-6/12">
                            <a href={dashboardHandlers.downloadClientPropertiesURLGenerator()} htmlFor="globalModal" className="btn no-animation btn-accent btn-block normal-case">Download Properties</a>
                        </div>
                    </div>
                    <div>
